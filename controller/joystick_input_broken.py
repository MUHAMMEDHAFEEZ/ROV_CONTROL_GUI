...
class JoystickInput:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.logger.info(Completed تهيئة نظام الجويستيك")
        except Exception as e:
            self.logger.error(fError in تهيئة pygame: {e})
    
    def scan_joysticks(self) -> List[str]:
        ""البحث عن الجويستيك الAvailable""
        joysticks = []
        try:
            ...
            self.logger.info(fCompleted العثور على {len(joysticks)} جويستيك)
            return joysticks
            
        except Exception as e:
            self.logger.error(fError in البحث عن الجويستيك: {e})
            return []
    
    def connect_joystick(self, joystick_id: int = 0) -> bool:
        ""Connection بجويستيك محدد""
        try:
            if pygame.joystick.get_count() <= joystick_id:
                self.logger.error(الجويستيك المطلوب Not available)
                return False
            ...
            self.logger.info(fCompleted Connection بالجويستيك: {self.joystick.get_name()})
            self.logger.info(fالمحاور: {self.joystick.get_numaxes()}, الأزرار: {self.joystick.get_numbuttons()})
            
            return True
            
        except Exception as e:
            self.logger.error(fError in Connection بالجويستيك: {e})
            return False
    
    def disconnect_joystick(self):
        ""قطع Connection بالجويستيك""
        self.is_connected = False
        self.stop_input()
        ...
        self.logger.info(Completed قطع Connection بالجويستيك)
    ...
    def start_input(self):
        ...
        self.logger.info(Completed بدء قراءة إدخال الجويستيك)
    ...
    def stop_input(self):
        ...
        self.logger.info(Completed إيقاف قراءة إدخال الجويستيك)
    ...
    def _input_loop(self):
        ...
        while self.is_active and self.is_connected:
            try:
                ...
                self.logger.error(fError in حلقة الإدخال: {e}")
                break
    ...
    def _read_axes(self):
        ...
        try:
            ...
            self.logger.error(fError in قراءة المحاور: {e}")
    ...
    def _read_buttons(self):
        ...
        try:
            ...
            self.logger.error(fError in قراءة الأزرار: {e}")
    ...
    def set_deadzone(self, deadzone: float):
        ...
        self.logger.info(fCompleted تعديل المنطقة الميتة: {self.deadzone})
    
    def set_sensitivity(self, sensitivity: float):
        ""تعيين الحساسية""
        self.sensitivity = max(0.1, min(2.0, sensitivity))
        self.logger.info(fCompleted تعديل الحساسية: {self.sensitivity})
    ...
    def calibrate(self):
        ...
        if self.joystick:
            ...
            self.logger.info(fCompleted حفظ القيم المرجعية: {center_values})
        
        self.logger.info(Completedت معايرة الجويستيك)
