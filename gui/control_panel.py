...
class ControlPanelWidget(QWidget):
    ...
    def _create_connection_controls(self) -> QGroupBox:
        """إنشاء أدوات الاتصال"""
        group = QGroupBox("الاتصال والحالة")
    ...
    def _create_movement_controls(self) -> QGroupBox:
        ...
        layout.addWidget(QLabel("أمامي/خلفي:"), 0, 0)
    ...
    def _create_control_modes(self) -> QGroupBox:
        ...
        speed_layout.addWidget(QLabel("السرعة:"))
    ...
    def _create_settings_controls(self) -> QGroupBox:
        """إنشاء أدوات الإعدادات"""
        group = QGroupBox("الإعدادات")
        layout = QVBoxLayout(group)
        
        # زر المعايرة
        calibrate_button = QPushButton("معايرة الحساسات")
        ...
        reload_button = QPushButton("إعادة تحميل الإعدادات")
    ...
    def _reload_settings(self):
        ...
        print("تم إعادة تحميل الإعدادات")
    ...
    def update_connection_status(self, connected: bool):
        ...
        if connected:
            ...
            self.connect_button.setText("قطع الاتصال")
            self.connect_button.setStyleSheet("""
                QPushButton {
                    background-color: #dc3545;
                    color: white;
